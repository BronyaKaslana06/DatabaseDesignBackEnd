...
INSERT INTO "Employee_MaintenanceItem" ("maintenanceItemsMaintenanceItemId", "employeesEmployeeId")
SELECT MAINTENANCE_ITEM_ID, EMPLOYEE_ID
FROM (
  SELECT MAINTENANCE_ITEM_ID,
         EMPLOYEE_ID,
         ROW_NUMBER() OVER (PARTITION BY MAINTENANCE_ITEM_ID ORDER BY DBMS_RANDOM.VALUE) AS rn
