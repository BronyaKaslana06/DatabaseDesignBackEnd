            ...
            try
            {
                var filteredItems = _context.MaintenanceItems
                    ...
                    .Select(joinedData => new
                    {
                        ...
                        order_submission_time = joinedData.MaintenanceItem.OrderSubmissionTime.ToString("yyyy-MM-dd"),
                        service_time = joinedData.MaintenanceItem.ServiceTime != null ? joinedData.MaintenanceItem.ServiceTime.Value.ToString("yyyy-MM-dd") : "未完成服务",
                        longtitude = joinedData.MaintenanceItem.longitude,
                        latitude = joinedData.MaintenanceItem.latitude,
                        appoint_time = joinedData.MaintenanceItem.AppointTime.ToString("yyyy-MM-dd"),
